...
public class JiaYuanController {
    ...
    public static void main(String[] args) {
        ...
        try {
             ...
             */
		     ...
		     controller.addSeed("http://www.youyuan.com/find/beijing/mm18-28/advance-0-0-0-0-0-0-0/p1/");
             ...
             * finished.
             */
            controller.start(JiaYuanCrawler.class, numberOfCrawlers);
            ...
            for (final Object localData : crawlersLocalData) {
                final CrawlStatJiaYuan stat = (CrawlStatJiaYuan) localData;
