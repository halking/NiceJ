 ...
 * 
 */
@WebServiceClient(name = "HelloWorld", targetNamespace = "http://jws.hal.com/", wsdlLocation = "http://localhost:8080/helloWorld?wsdl")
public class HelloWorld_Service extends Service {
	...
	private final static QName HELLOWORLD_QNAME = new QName("http://jws.hal.com/", "HelloWorld");
	...
	public HelloWorld getHelloWorldImplPort(WebServiceFeature... features) {
		return super.getPort(new QName("http://jws.hal.com/", "HelloWorldImplPort"), HelloWorld.class, features);
	}
