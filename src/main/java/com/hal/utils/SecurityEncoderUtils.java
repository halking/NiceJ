...
public class SecurityEncoderUtils {
	    ...
	    public static void main(String[] args) {
	    	...
	    	securityEncoderUtils.setCharacterEncoding("UTF-8");
			String enCodedPasswd = securityEncoderUtils.encode("c78ca76b9ae843c9b03e360b047552a0Hdbjfjb一q7w7d8dk9wk3k4nr8h");
