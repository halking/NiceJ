...
public class QueueTalk implements javax.jms.MessageListener {
	private static final String DEFAULT_BROKER_NAME = "tcp://localhost:61616";
	private static final String DEFAULT_PASSWORD = "password";
	private static final int MESSAGE_LIFESPAN = 1800; // milliseconds (30
															// minutes)
	...
	/**
	 * Handle the message (as specified in the javax.jms.MessageListener
	 * interface).
	 */
	public void onMessage(javax.jms.Message aMessage) {
		try {
			...
			if (aMessage instanceof javax.jms.TextMessage) {
				...
				System.out.println("Warning: A message was discarded because it could not be processed " + "as a javax.jms.TextMessage.");
			}
	...
	public static void main(String argv[]) {
		...
		String qSender = "sender";
		String qReceiver = "receiver";
